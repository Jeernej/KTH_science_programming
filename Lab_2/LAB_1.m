...
global array
array=[22, 36, 6, 79, 26, 45, 75, 13, 31, 62, 27, 76, 33, 16, 47];
...
k=1;
j=k;
while i<L-1   % Scan from left of the array
...
% !!!!! How can you change partition function so that it works correctly event in this case?
