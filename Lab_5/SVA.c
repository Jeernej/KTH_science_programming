...
//        printf("%c", readtemp);
   ...
   printf("\nNumber of vectors in the file is %d.\n",ALL_VECTORS);
...
//                printf("\nindex10  is v%d\n", INDEX_1);
            ...
            //// vector values definitions with calculations
                ...
                if( (operat[0]=='t') && (operat[1]=='e') && (operat[2]=='m') && (operat[3]=='p') && (operat[4]==' ') ) { TEMP=1;} // get temp and print it out
...
//                                    printf("\nindex2  is v%d\n", INDEX_2);
                                ...
                                else if( (operat[EQ_pos+2]=='t') && (operat[EQ_pos+3]=='e') && (operat[EQ_pos+4]=='m') && (operat[EQ_pos+5]=='p') && (operat[EQ_pos+6]==' ') ) { TEMP=1;} // get temp and print it out
...
//       struct svector *x=&SV3;  /// for reading 
       ...
       if (index1==0) {result=&SV0; }// write calcualted data to GLOBAL results linked list SV0
...
// get vector from vector index
       ...
       if(size_1>=size_2){size_max=size_1;size_min=size_2;} 
       else{size_max=size_2;size_min=size_1;}
